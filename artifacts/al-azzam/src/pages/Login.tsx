      ...
      <div className="w-full max-w-md bg-card border shadow-xl rounded-3xl p-8 relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <Input {...register("email")} type="email" placeholder="admin@azzam.com" dir="ltr" className="text-left" />
        ...
        <div className="mt-6 text-center text-sm text-muted-foreground bg-muted/50 p-4 rounded-xl">
          <p className="font-semibold mb-1">Test Accounts:</p>
          <p dir="ltr">admin1@azzam.com / 123456</p>
          <p dir="ltr">user@azzam.com / 123456</p>
        </div>
      </div>
    </div>
  );
